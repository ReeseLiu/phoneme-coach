...
const I18N = {
  "zh-TW": {
    ...
    presentationPlayRange: "播放範圍 ⟲",
    presentationStopRange: "停止範圍",
    presentationPlayRangeHint: "在指定範圍內循環播放",
    presentationStopRangeHint: "停止範圍循環",
    presentationRangeSelect: "設定範圍",
    presentationRangeSelectOn: "圈選中：點起句、再點訖句（自動完成）",
    presentationRangeSelectOff: "設定循環範圍：點兩句指定起訖",
    presentationRangeClear: "清除範圍",
    presentationLoopDisabledByRange: "範圍循環中，單句循環暫不可用",
    ...
    toneHeader: "語調",
    presentationToneToggleOn: "語調開",
    presentationToneToggleOff: "語調關",
    presentationToneToggleOnHint: "隱藏語調標示",
    presentationToneToggleOffHint: "顯示語調標示",
  ...
  en: {
    ...
    presentationPlayRange: "Play Range ⟲",
    presentationStopRange: "Stop Range",
    presentationPlayRangeHint: "Loop playback within the selected range",
    presentationStopRangeHint: "Stop range loop",
    presentationRangeSelect: "Set Range",
    presentationRangeSelectOn: "Selecting: click start, then end (auto-finishes)",
    presentationRangeSelectOff: "Set loop range: click two sentences for start/end",
    presentationRangeClear: "Clear range",
    presentationLoopDisabledByRange: "Range loop active; single-sentence loop unavailable",
    ...
    toneHeader: "Tone",
    presentationToneToggleOn: "Tone On",
    presentationToneToggleOff: "Tone Off",
    presentationToneToggleOnHint: "Hide tone marks",
    presentationToneToggleOffHint: "Show tone marks",
